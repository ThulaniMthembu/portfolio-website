  ...
  return (
    <>
      ...
      <div className={`flex flex-col items-center justify-center min-h-screen bg-gray-900 px-4 py-8 transition-opacity duration-1000 ${isVisible ? 'animate-fadeIn opacity-100' : 'opacity-0'} ${isFading ? 'animate-fadeOut' : ''}`}>
        ...
        <div className="w-[340px] bg-[#191919] rounded-[2em] p-[20px] shadow-[5px_5px_30px_rgb(4,4,4),-5px_-5px_30px_rgb(57,57,57)] transition-all duration-300 hover:shadow-[0_0_20px_5px_#fca311]">
          <div className="flex flex-col items-center">
            <div className="mt-5 w-[200px] h-[200px] rounded-full overflow-hidden transition-transform duration-300 hover:scale-105">
              <Image
            ...
            <h2 className="text-white font-sans text-2xl mt-6 mb-2 transition-colors duration-300 hover:text-[#fca311]">Thulani Mthembu</h2>
            <p className="text-white text-lg mb-4 transition-colors duration-300 hover:text-[#fca311]">FrontEnd React Dev</p>
            <p className="text-[#fca311] text-base mb-2 text-center">Quick Links to Get in Touch:</p>
            <div className="flex flex-col items-center space-y-2 mb-4">
              ...
              <a href="mailto:thulanim457@gmail.com" className="text-white hover:text-[#fca311] transition-all duration-300 flex items-center hover:scale-105">
                <Mail className="w-5 h-5 mr-2" />
                thulanim457@gmail.com
              </a>
            </div>
            <div className="w-[90%] bg-[#191919] rounded-[3em] p-4 mt-2 shadow-[3px_3px_15px_rgb(0,0,0),-3px_-3px_15px_rgb(58,58,58)] flex justify-center space-x-6 transition-all duration-300 hover:shadow-[0_0_10px_2px_#fca311]">
        ...
        <button
          ...
          className="mt-8 px-8 py-3 bg-[#fca311] text-white text-lg font-semibold rounded-full transition-all duration-300 ease-in-out hover:bg-white hover:text-[#fca311] hover:scale-105"
        >
          View Full Portfolio
        </button>
      </div>
